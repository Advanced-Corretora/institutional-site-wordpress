		...
		<div class="footer-section footer-menu-section">
			...
			if (! empty($social_networks)) : ?>
				<div class="footer-section footer-social-section">
					...
					<?php 
					$social_disclaimer = carbon_get_theme_option('footer_social_disclaimer');
					if (! empty($social_disclaimer)) : ?>
						<div class="footer-social-disclaimer">
							<?php echo wp_kses_post($social_disclaimer); ?>
						</div>
					<?php endif; ?>
				</div>
			<?php endif; ?>
